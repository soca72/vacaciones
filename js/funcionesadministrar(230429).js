...
//                   </li>";
                ...
                tr = tr + "</td></tr>";
                     tr = tr +"<tr  class='sinBorde comentario " + clase +"' id='comentario"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario del solicitante: </b>"+lineas[i].COMENTARIO+"</td>\
                            <td colspan='2'></td></tr>";
                     tr = tr +"<tr class='sinBorde comentarioJefe " + clase +"' id='comentarioJefe"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario Jefe de area: </b>"+lineas[i].COMENTARIOJEFE+"</td>\
                            <td colspan='2'></td></tr>";
                     tr = tr +"<tr class=' sinBorde comentarioRH " + clase +"' id='comentarioRH"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario RH:</b> "+lineas[i].COMENTARIORH+"</td>\
                            <td colspan='2'></td></tr>";
...
//    }
                ...
                element1 = document.getElementById('comentario'+idsolicitud+'');
                ...
                element2 = document.getElementById('comentarioJefe'+idsolicitud+'');
                estado2 = element2.style.display;
                if(estado2 == 'revert'){
                element2.style.display='none';
                }else{
                element2.style.display = 'revert'; 
                }
                
                element3 = document.getElementById('comentarioRH'+idsolicitud+'');
                estado3 = element3.style.display;
                if(estado3 == 'revert'){
                element3.style.display='none';
                }else{
                element3.style.display = 'revert'; 
                }
