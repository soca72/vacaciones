							    ...
							    for (var i=0; i<lineas.length; i++) 
							    		{
								            ...
								            "<td style=' padding-top: 15px; '>" + (clase!='success' && clase!='danger'?"<input type='checkbox' class='"+(($("#idDep").val() != "29" && typeof lineas[i].JEFEAPROBO=='undefined') || ($("#idDep").val() == "29" && typeof lineas[i].RHAPROBO=='undefined')|| ($("#idDep").val() == "30" && typeof lineas[i].GERENTEAPROBO=='undefined')?"chkAprobar":"")+" " + (typeof lineas[i].RHAPROBO=='undefined'?"chkCancelar":"") + "' idSolicitud = '" + lineas[i].IDSOLICITUD + "' name='chkSolicitud' id='chk-" + lineas[i].IDSOLICITUD + "'>":"") + "</td>" +
												...
												if(lineas[i].FECHAAUTORIZOJEFEAREA || "")
								        		...
								        		else
								        			{
								        				...
								        				tr = tr + "<td style=' padding-top: 15px;'>" + "-" + "</td>" ;
                                                                                                ...
                                                                                                {
                                                                                                    tr = tr + "<td style=' padding-top:15px; '>" + lineas[i].GERENTEAPROBO + "</td>";
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    tr = tr + "<td style=' padding-top:15px;'>" + "-" + "</td>";
                                                                                                ...
                                                                                                if(lineas[i].FECHAAUTORIZOGERENTE || "")
                                                                                                {
                                                                                                    ...
                                                                                                    tr = tr + "<td style=' padding-top:15px;'>" + splitFechasGerente[0] + "<br>"+splitFechasGerente[1]+ "</td>";
                                                                                                }
                                                                                                else{
                                                                                                    tr = tr + "<td style=' padding-top: 15px;'>" + "-" + "</td>" ;
                                                                                                }
...
//                   </li>";
                ...
                if(lineas[i].COMENTARIO.length<=1 && lineas[i].COMENTARIOJEFE.length<=1 && lineas[i].COMENTARIORH.length<=1 && lineas[i].COMENTARIOGERENTE.length<=1 ){
                    tr = tr +"<tr  class='sinBorde comentario " + clase +"' id='comentario"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='14'><b>Sin Comentarios </b></td>\
                            <td colspan='2'></td></tr>";
                }else{
                
                if(lineas[i].COMENTARIO.length>1){
                     tr = tr +"<tr  class='sinBorde comentario " + clase +"' id='comentario"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none !important;' >\
                            <td colspan='1'></td><td colspan='14'><b>Comentario de solicitante: </b>"+lineas[i].COMENTARIO+"</td>\
                            <td colspan='2'></td></tr>";
                    validaComentario = true;
                }
                if(lineas[i].COMENTARIOJEFE.length>1 ){
                             tr = tr +"<tr class='sinBorde comentarioJefe " + clase +"' id='comentarioJefe"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                                    <td colspan='1'></td><td colspan='14'><b>Comentario de jefe de área: </b>"+lineas[i].COMENTARIOJEFE+"</td>\
                                    <td colspan='2'></td></tr>";
                    validaComentarioJefe = true;
                }
                
                if(lineas[i].COMENTARIOGERENTE.length>1 ){
                             tr = tr +"<tr class='sinBorde comentarioGerente " + clase +"' id='comentarioGerente"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                                    <td colspan='1'></td><td colspan='14'><b>Comentario Gerente: </b>"+lineas[i].COMENTARIOGERENTE+"</td>\
                                    <td colspan='2'></td></tr>";
                    validaComentarioGerente = true;
                }
                
                if(lineas[i].COMENTARIORH.length>1){
                             tr = tr +"<tr class=' sinBorde comentarioRH " + clase +"' id='comentarioRH"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                                    <td colspan='1'></td><td colspan='14'><b>Comentario de RH:</b> "+lineas[i].COMENTARIORH+"</td>\
                                    <td colspan='2'></td></tr>";
