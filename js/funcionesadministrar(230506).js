                ...
                {*/
                   ...
                   // $("#btncomentarioSuperiores").off('click');
	            	...
	            	$.get("apruebasolicitud.php", //url
	            			{idsolicitud:idsolicitud,idsolicituddepto:idsolicituddepto, Jefe:jefea, RH:rh , idusuario: idusuario ,accion:'a',iddepartamento:iddepartamento,comentarioSuperiores:comentarioSuperiores }, //datos
							    ...
							    for (var i=0; i<lineas.length; i++) 
							    		{
							    			...
							    			//******************************************************************
                                                                                ...
                                                                                tr = tr + "<tr style='border-top:1px solid #000;' class='" + clase + "' id='tr"+lineas[i].IDSOLICITUD+"' onclick=mostrarComentario("+lineas[i].IDSOLICITUD+",validaComentario,validaComentarioJefe,validaComentarioRh)>" +
...
//                   </li>";
                ...
                if(lineas[i].COMENTARIO.length<=1 && lineas[i].COMENTARIOJEFE.length<=1 && lineas[i].COMENTARIORH.length<=1 ){
                    tr = tr +"<tr  class='sinBorde comentario " + clase +"' id='comentario"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Sin Comentarios </b></td>\
                            <td colspan='2'></td></tr>";
                }else{
                
                if(lineas[i].COMENTARIO.length>1){
                     tr = tr +"<tr  class='sinBorde comentario " + clase +"' id='comentario"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario de solicitante: </b>"+lineas[i].COMENTARIO+"</td>\
                            <td colspan='2'></td></tr>";
        ...
        if(lineas[i].COMENTARIOJEFE.length>1 ){
                     tr = tr +"<tr class='sinBorde comentarioJefe " + clase +"' id='comentarioJefe"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario de jefe de área: </b>"+lineas[i].COMENTARIOJEFE+"</td>\
                            <td colspan='2'></td></tr>";
        ...
        if(lineas[i].COMENTARIORH.length>1){
                     tr = tr +"<tr class=' sinBorde comentarioRH " + clase +"' id='comentarioRH"+  lineas[i].IDSOLICITUD  +"' style=' border-bottom:none;' >\
                            <td colspan='1'></td><td colspan='12'><b>Comentario de RH:</b> "+lineas[i].COMENTARIORH+"</td>\
                            <td colspan='2'></td></tr>";
...
function mostrarComentario(idsolicitud,validaComentario,validaComentarioJefe,validaComentarioRh){
