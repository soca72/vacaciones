								        	...
								        	if(lineas[i].RHAPROBO || "")
                                                                                ...
                                                                                if(lineas[i].FECHAAUTORIZORECURSOSH || "")
								            		{
								            			tr = tr + "<div class='col " + clase + " text-center'><div class='esconder'>" + lineas[i].ORDENFECHAAUTORIZORECURSOSH + "</div>" + lineas[i].FECHAAUTORIZORECURSOSH + "</div>" ;
                                                                                ...
                                                                                tr += "<div class='col-12 " + clase + " comentario'><b>Comentarios:</b> " + lineas[i].COMENTARIO + "</div>" 
...
//                if(!$(this).find(".comentarioJefe").is(":visible"))$(this).find(".comentarioJefe").slideDown(50);
//                else $(this).find(".comentarioJefe").slideUp(50);
//                if(!$(this).find(".comentarioRH").is(":visible"))$(this).find(".comentarioRH").slideDown(50);
//                else $(this).find(".comentarioRH").slideUp(50);
            });
