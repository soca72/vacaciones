...
#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(6),#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(6){
    min-width: 250px;  
}



#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(3), 
...
#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(13){
   
}

#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(2), 
#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(3),
#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(8), 
#divSolicitudes > .row  > .container-fluid > .row > div:nth-child(9),
#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(1), 
#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(2),
#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(3), 
#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(8), 
#divEncabezadosSolicitudes > .row  > .container-fluid > .row > div:nth-child(9){
    max-width: 60px;
}
                ...
                <div class='modal-dialog ' role='document'>
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            <textarea type='text' id='comentarioSuperiores' name='comentarioSuperiores' cols='65' rows='3' placeholder='Comentarios (Opcional)' ></textarea>
                        </div>
            ...
            <td>
                <div class='dropdown'>
                    <button class='btn btn-default btn-md dropdown-toggle' type='button' data-toggle='dropdown'>
                        <span class='glyphicon glyphicon-home'></span> Sucursal<span class=''></span>
                    </button>
                    <ul class='dropdown-menu' style='width: 330px;height: 220px;max-height: 200px; overflow-x: hidden;' role='menu'>
                        <li>
                            <table class='tableDrop'>
                                <tr>
                                    <td style='width:2%;'><input type='checkbox' id='dep_-44' onclick=\"checkTodos(document.getElementById('chkTodos').value)\"></td>
                                    <td>Todas</td>
                                </tr>
                            </table>
                        </li>";
                            $cursor=oci_new_cursor($conn);
                            $sql="BEGIN VAC_PRC_ACCESOSUCURSALES(:idu,:sucursales);End;";
                            $stmt=oci_parse($conn,$sql);
                            oci_bind_by_name($stmt,":idu",$idusuarioData,32);
                            oci_bind_by_name($stmt, ":sucursales", $cursor, -1, OCI_B_CURSOR);
                            oci_execute($stmt);
                            oci_execute($cursor);
                            $sucursales=array(0=>"COMODIN",);
                            $idCheckBox="";
                            $i=1;
                            while (($row = oci_fetch_array($cursor, OCI_BOTH)) != false) {
                                array_push($sucursales,$row[0]);
                                //array_push($idCheckBox,$row[1]);
                                $idCheckBoxSuc=$idCheckBoxSuc.$row[1].";";
                   echo "<li>
                            <table class='tableDrop'>
                                <tr>
                                    <td style='width:2%;'><input type='checkbox' id='dep_$row[1]' onchange=agregafiltrosucursal($row[1],document.getElementById('chkTodosSuc').value)></td>
                                    <td>$sucursales[$i]</td>
                                </tr>
                            </table>
                        </li>";
                            ...
                            echo "<input type='hidden' name='chkTodosSuc' id='chkTodosSuc' value='$idCheckBoxSuc'>";
                echo "</ul>
                </div>
            </td>
            <td>
                <div class='dropdown'  > 
                   ...
                   echo "<li>
                            <table class='tableDrop'>
                                <tr>
                                    <td style='width:2%;'><input type='checkbox' id='dep_$row[1]' onchange=agregafiltrodepartamento($row[1],document.getElementById('chkTodos').value)></td>
...
<div id='divEncabezadosSolicitudes' class='container-fluid'>
    <div class='row'>
        <div class='container-fluid'>
            <div class='row'>
                <div class='text-center col encabezado' ><input type='checkbox' id='chk-All'></div>
                <div class='text-center col encabezado' >ID</div>
                <div class='text-center col encabezado' >FECHA</div>
                <div class='text-center col encabezado' >SUCURSAL</div>
                ...
                <div class='text-center col encabezado' >FECHA AUTORIZA</div>
                <div class='text-center col encabezado' >ACCIONES</div>
            </div>
        </div>
    </div>
</div>
