...
<td>
                ...
                <span class='glyphicon glyphicon-search'></span> Departamento<span class='caret'></span>
                </button>
   ...
   echo "<table class='table' style='margin: unset;'>
            <tr>
            <td width='25%' style='background-color:#C1FFA9;'><b>Aprobadas</b></td>
            <td width='25%' style='background-color:#f2dede;'><b>Canceladas</b></td>
            <td width='25%' style='background-color:#FFF2AB;'><b>Pendientes</b></td>
            <td width='25%' style='background-color:#A9E3FF;'><b>Parcialmente Aprobadas</b></td>
            </tr>
            </table>"; 
