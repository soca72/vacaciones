...
";
                            echo "<div class='container' >
                                ...
                                <div class='text-center py-2 col-2 d-flex align-items-center justify-content-center'>Fecha</div>
                                <div class='text-center py-2 col-6 d-flex align-items-center justify-content-center'>Descripci&oacuten</div>
                                <div class='col-1 py-2 d-flex align-items-center justify-content-center'>Editar</div>
                                <div class='col-1 py-2 d-flex align-items-center justify-content-center'>Guardar</div>
                                <div class='col-1 py-2 d-flex align-items-center justify-content-center'>Eliminar</div>
                                <div class='col-1 py-1 text-white d-flex align-items-center justify-content-center'><button onclick='mostrarOcultarArea();' class='btn' style='width:100%; font-size:12px;' type='button' title='Agregar nueva area'><i class='fa-solid fa-plus'></i></button></div>
                            </div>
                            </div>";
                          ...
                          $aux2=0;
                            ...
                            echo "
                                ...
                                <input type=hidden id=idFecha name=idFecha>
                                 <div class=' row  ' >
                                    <div class='text-center py-2 col-2 d-flex align-items-end justify-content-center' ><input type=text name=fechaFestivo id=fechaFestivo style='width:100%; font-size:12px;' placeholder='Fecha'>";
                                    
                                    echo "</div>
                                        <div class='text-center py-2 col-6 '>
                                         <input type=text name=descripcion id=descripcion style='width:100%; font-size:12px;' placeholder='Descripcion' required>
                                        </div>
                                        ...
                                        <div class='col-1 text-center py-2 '>
                                          <button class='btn' style='width:100%; font-size:12px;' type=reset value=Limpiar onclick=document.getElementById('idFecha').value='';><i class='fa-solid fa-xmark' style='color:red; '></i></button>
                                        </div>
                                         </div>
                                    </form>   
                  ...
                  <input id='mandarinfo' type=submit value='oculto' hidden>
                            ...
                            ";
                                    ...
                                    echo "
                                        <div class='container' >
                                 <div class=' row  ' >";
                                 $sql="SELECT * FROM VAC_DIAS_NO_HABILES ORDER BY FECHA desc";///este procedure regresara las solicitudes pintandolos en los calendarios
$cursor = oci_new_cursor($conn);
$stmt= oci_parse($conn, $sql);
oci_execute($stmt);
while (($row = oci_fetch_array($stmt, OCI_BOTH)) != false)
{   
    echo"<div class=' col-2 py-2 ' style='font-size:12px;' >$row[1] </div>";
    echo"<div class='col-6 py-2' style='font-size:12px;'>$row[2] </div>";
    
    echo"<div class='text-center  col-1 py-2' ><button  class='btn' style='width:100%; font-size:12px;' title='Modificar Asociación'  style='cursor: hand;' onclick=\"editar($row[0],'$row[1]','$row[2]'),mostrarInput()\"><i class='fa-solid fa-edit '></i></button></div>";
